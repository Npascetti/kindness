		...
		<main>
			<h2>Bio</h2>
				<ul>
					...
					<li>Archetypr: Upper Class Soccer Dad </li>
					<li>Tech: iPhone X and Wiondows surrface running windows10</li>
				</ul>
			<p>Robert grew up in a single parent household where he didn't get to eat every meal. His mother worked hard
				...
				community, specifically to those in his priior position. He wants to teach his kids the value in giving to those who dont have.
			...
			<h2>Goals</h2>
				<ul>
					...
					<li>Build chracter for his kids</li>
					<li>Wants to be in control of his donations</li>
				</ul>
			<h2>Fustrations</h2>
				<ul>
					<li>Consistently running out of time to donate</li>
					<li>Not knowing where to donate</li>
					<li>Lack of public resources</li>
				</ul>
		</main>
	</body>
</html>
